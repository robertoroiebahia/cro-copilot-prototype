      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-6 py-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="heading-page">Experiments</h1>
            </div>
            <p className="text-body-secondary">A/B test tracking with live results</p>
          </div>
        </div>
        ...
        <main className="max-w-7xl mx-auto px-6 py-12">
          <EmptyState
            ...
            description="Experiments are A/B tests created from approved hypotheses. Create and approve hypotheses first, then convert them into experiments ready to run with full tracking and results analysis."
            actionLabel="View Hypotheses"
            actionHref="/hypotheses"
        ...
        <div className="mb-6">
          <div className="flex items-center gap-8 flex-wrap">
            <div>
              ...
              <div className="text-label">Total Tests</div>
            </div>
            <div className="h-12 w-px bg-gray-200"></div>
            <div>
              <div className="text-stat-medium text-purple-600 mb-1">{stats.running}</div>
              <div className="text-label">Running</div>
            </div>
            <div className="h-12 w-px bg-gray-200"></div>
            <div>
              <div className="text-stat-medium text-gray-600 mb-1">{stats.completed}</div>
              <div className="text-label">Completed</div>
            </div>
            <div className="h-12 w-px bg-gray-200"></div>
            <div>
              <div className="text-stat-medium text-green-600 mb-1">{stats.wins}</div>
              <div className="text-label">Wins</div>
            </div>
            <div className="h-12 w-px bg-gray-200"></div>
            <div>
              <div className="text-stat-medium text-red-600 mb-1">{stats.losses}</div>
              <div className="text-label">Losses</div>
            </div>
            <div className="h-12 w-px bg-gray-200"></div>
            <div>
              <div className="text-stat-medium text-yellow-600 mb-1">{stats.inconclusive}</div>
              <div className="text-label">Inconclusive</div>
            </div>
          </div>
        </div>
