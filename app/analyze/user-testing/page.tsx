      ...
      <div className="bg-gradient-to-b from-gray-50 to-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <nav className="flex items-center gap-2 text-sm mb-4">
            ...
            <span className="text-brand-black font-black">User Testing Analysis</span>
          </nav>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-black text-brand-black">User Testing Analysis</h1>
              <p className="text-sm text-brand-text-secondary font-medium">Transform user testing into actionable insights</p>
            </div>
          </div>
        </div>
      </div>
