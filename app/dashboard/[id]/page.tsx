        ...
        {analysis.screenshots && (
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6 border border-gray-200">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {analysis.screenshots.desktopAboveFold && (
                <div>
              ...
              {analysis.screenshots.mobileAboveFold && (
                <div>
                  ...
                  <img
                    src={`data:image/png;base64,${analysis.screenshots.mobileAboveFold}`}
