/**
 * Usage Tracking Utilities - SERVER-SIDE ONLY
 * Use this in API routes and server components
 * For client-side, use usage-tracking-client.ts
 */
 ...
 * @param count - Number to increment by (default: 1). Useful for bulk operations like saving multiple insights.
 */
